...
namespace Ch05
{
    ...
    // 상속
    // 클래스 명 뒤에 콜론 하고 부모 클래스 명
    // 생성자에서 base(부모 생성자의 변수)
    class Child : Parent 
    {
        private int num3;
        private int num4;
    ...
    internal class _4_상속
    {
        static void Main4(string[] args)
        {
            ...
            Console.WriteLine("c1.Plus : {0}", c1.Plus());
            Console.WriteLine("c1.Minus : {0}", c1.Minus());
            Console.WriteLine("c2.Plus : {0}", c2.Plus());
            Console.WriteLine("c2.Minus : {0}", c2.Minus());
