...
namespace Private
{
    ...
    internal class _6_attribute
    {
        static void Main6(string[] args)
        {
            ...
            _6_attribute a = new _6_attribute();

            // 메소드들의 집합
            var methods = typeof(_6_attribute).GetMethods(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance).ToList();      
