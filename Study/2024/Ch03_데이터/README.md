...
크기(표현)범위가 다른 정수 형식 사이의 변환에서나<br/>
부호 있는 정수 형식과 부호 없는 정수 형식 사이의 변환에서는<br/>
...
크기(표현)범위가 다른 부동 소수점 형식 사이의 변환에서는<br/>
2진수로 표현하는 소수는 완벽하지 않다.<br/>
그래서 오차가 발생한다.<br/>
...
문자열과 숫자 사이의 변환에서는<br/>
오차범위 안인 경우 이상없이 저장된다.<br/>
